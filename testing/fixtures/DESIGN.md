...
and transfers cleanup ownership only after setup succeeds. Dropping the fixture stops
its named container. Computers admission and shared Task recovery use the same setup,
