...
- It imports `sdk/python` from the fork checkout and locks third-party dependencies.
...
- From the repository root: `docker buildx bake anonymous-simulation-mcp --print`
