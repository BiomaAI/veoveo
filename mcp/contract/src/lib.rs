...
pub use gateway::{
    ...
    RecordingDatasetName, RecordingIngestResource, RecordingIngestStreamId, RecordingProducerId,
    ...
    UpstreamEndpoint, UpstreamTransport, UpstreamTransportSecurity, UpstreamUrl, WorkContextId,
