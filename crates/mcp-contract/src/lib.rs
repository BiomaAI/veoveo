...
pub use gateway::{
    ...
    GatewayControlPlane, GatewayControlPlaneError, GatewayJwtRevocation, GatewayProfile,
    GatewayProfileId, GatewayResourceSubscription, GatewayTaskId, GatewayTaskMapping,
