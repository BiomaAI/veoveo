...
pub use gateway::{
    ...
    McpSurfaceCapability, MountPath, OwnedRoute, OwnedRoutePurpose, PolicyDecision, PolicyEffect,
    ...
    SecretSource, ServerManifest, ServerSlug, TaskExposure, TenantId, TokenIssuer, TokenSubject,
