...
pub use gateway::{
    ...
    CertificateAuthorityFilePath, CertificateAuthoritySource, CompletionExposure,
    DataLabelDefinition, DataLabelId, Exposure, GatewayAction, GatewayAuthorizationCodeRecord,
    ...
    IdentityProviderTenantClaim, IdentityProviderTenantClaimMapping,
