...
use veoveo_mcp_contract::{
    ...
    GatewayAuthorizationRequest, GatewayProfileId, OAuthClientAuthMethod, OAuthClientId,
    OAuthGrantType, OAuthRedirectUri, OAuthStateValue, PkceCodeChallenge, PkceCodeChallengeMethod,
    SecretPurpose,
};
use veoveo_mcp_gateway::{
    ClientAssertionConfig, ClientAssertionVerifier, GatewaySecretResolver, OidcIdTokenConfig,
    OidcIdTokenVerifier,
};
...
use crate::{
    ...
    http_util::{
        ...
        random_authorization_code, random_oauth_state, random_oidc_nonce, random_pkce_verifier,
