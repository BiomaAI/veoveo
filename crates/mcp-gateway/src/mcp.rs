...
use rmcp::{
    ...
    model::{
        ...
        Reference, ServerCapabilities, ServerInfo, ServerNotification, ServerResult,
        SubscribeRequestParams, TaskStatusNotificationParam, TasksCapability,
...
use veoveo_mcp_contract::{
    ...
    LocalToolName, PolicyDecision, PolicyEffect, PolicyReasonCode, PolicyTarget, PrincipalId,
    PromptName, ResourceUri, ServerResourceUri, ServerSlug, TaskExposure as ContractTaskExposure,
    TaskIdProjection, TraceId, UpstreamTaskId, UpstreamTransport, paginate,
};

use crate::{
    AuthenticatedSubject, GatewayCatalogHandle, GatewayState, PolicyRequest,
    mcp_support::{
        audit_method_name, ensure_unique_prompts, gateway_resource_uri, mcp_internal,
        mcp_invalid_params, mcp_invalid_request, parse_gateway_tool, project_listed_resource,
        project_read_resource_result, project_task_payload_result,
        project_upstream_resource_for_owner, resource_policy_target, resource_read_action,
