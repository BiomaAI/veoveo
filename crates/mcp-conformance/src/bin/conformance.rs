...
use veoveo_mcp_contract::{
    ...
    GatewayControlPlaneRevision, GatewayInternalIdentity, GatewayInternalTokenIssuer,
    GatewayInternalTokenVerifier, GatewayJwtRevocation, GatewayJwtRevocationApplyResult,
