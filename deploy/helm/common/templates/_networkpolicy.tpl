{{- define "veoveo-common.networkPolicy" -}}
...
metadata:
  ...
  labels:
    {{- include "veoveo-common.labels" .labels | nindent 4 }}
spec:
  podSelector:
    matchLabels:
      {{- include "veoveo-common.componentSelector" $selector | nindent 6 }}
...
spec:
  ...
  ingress:
    - from:
        - podSelector:
            matchLabels:
              {{- include "veoveo-common.componentSelector" (dict "installation" .installation "component" "gateway") | nindent 14 }}
      ports:
        - protocol: TCP
  ...
  egress:
    - to:
        - podSelector:
            matchLabels:
              {{- include "veoveo-common.installationSelector" (dict "installation" .installation) | nindent 14 }}
    - to:
        - namespaceSelector:
            matchLabels:
    ...
    - to:
        ...
        - podSelector:
            matchLabels:
              {{- include "veoveo-common.componentSelector" (dict "installation" $.installation "component" .component) | nindent 14 }}
        {{- else if .cidr }}
        - ipBlock:
            cidr: {{ .cidr | quote }}
        {{- else }}
