...
impl PlatformComponent {
    fn image(self) -> Option<&'static str> {
        match self {
            Self::Gateway => Some("mcp-gateway"),
            Self::ArtifactService => Some("artifact-service"),
            Self::Console => Some("console-bff"),
            Self::PlatformStore | Self::ObjectStore | Self::Telemetry | Self::Ingress => None,
        }
    }
}
...
impl FirstPartyMcpServer {
    fn images(self) -> &'static [&'static str] {
        match self {
            ...
            Self::Recording => &["recording-hub", "recording-mcp"],
