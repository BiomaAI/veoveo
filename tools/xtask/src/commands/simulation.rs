...
const DOCKERFILE: &str = r#"# syntax=docker/dockerfile:1.7
FROM scratch
ARG SOURCE_REVISION
...
pub(crate) fn publish(
    ...
    let build_lock_path = source_root.join("showcase/uav-sim/runtime/simulation-runtime.lock.json");
    ...
    let evidence = SimulationRuntimeReleaseEvidence {
        ...
        base_image: ArtifactDescriptor {
            name: ArtifactName::new("uav-sim-base")?,
