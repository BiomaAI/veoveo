...
| `veoveo.io/deployment/v7` | optional repository-development profile with installation-owned values, exact platform publication, managed GPU allocator closure, and configurable private-registry transport |
| `veoveo.io/deployment-lock/v7` | immutable installation revision, source evidence, and managed allocator artifacts emitted by that repository-development publication flow |
