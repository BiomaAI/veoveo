...
| `platform/computers/src/commands/` and `queries/queue_command.surql` | encrypted command admission, current grant/policy transaction fences, distinct execution slots and recoverable metadata-only Tasks; dispatch and public execution remain work |
