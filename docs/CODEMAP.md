...
| `platform/computers/src/files/` | private file admission authority, encrypted request journal, shared execution slot, recoverable Task linking and protected Artifact capability preparation; native worker and public activation remain pending |
