...
| `platform/computers/src/files/` | private file authority, encrypted request and capability preparation, one-shot dispatch, live continuation, bounded original-run containment, result settlement and recoverable Task delivery; native worker and public activation remain pending |
