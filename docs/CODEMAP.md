...
| [`apps/workspace/`](../apps/workspace/DESIGN.md) | independent productivity client: shared human chats, owner controls, invitation inbox, assistant-ui adapter and local headed browser acceptance; agent execution, capabilities and deployment remain active work |
