...
| `platform/computers/src/files/` | private file authority, encrypted request and capability preparation, one-shot dispatch, live continuation, bounded original-run containment, result settlement and recoverable Task delivery; native service integration is implemented privately; public activation remains pending |
