...
| `servers/computers-mcp/src/command_worker.rs` and `src/command_worker/` | original-receipt native command execution, bounded live authority, Artifact output publication, lease recovery, interruption containment and Task settlement; production configuration and public admission remain work |
