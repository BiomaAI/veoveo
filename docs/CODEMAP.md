...
| [`platform/store/src/workspace/runs/`](../platform/store/src/workspace/runs/DESIGN.md) | per-chat agent admission, atomic human-turn participation in `workspace/participation.rs`, bounded concurrent runs, fixed context, execution fences, cancellation and interrupted-worker recovery |
