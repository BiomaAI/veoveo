...
| `platform/computers/src/commands/` and `queries/{queue,dispatch}_command.surql` | encrypted admission, grant/policy fences, distinct execution slots, metadata-only Tasks and one-shot leased dispatch; containment and public execution remain work |
