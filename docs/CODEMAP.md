...
| [`ARTIFACT_UPLOAD_PLAN.md`](ARTIFACT_UPLOAD_PLAN.md) | proposed public HTTP artifact admission and streaming upload, Work Context authorization, durable receipts and retries, and external-to-Python acceptance |
