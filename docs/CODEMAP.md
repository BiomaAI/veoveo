...
| [`apps/workspace/`](../apps/workspace/DESIGN.md) | independent productivity client: shared chats, owner controls, invitation inbox, assistant-ui renderer, concurrent agents and durable private Tasks; `ResourceResult.tsx` projects governed Artifact result actions; release 159 is installed and further capability integration remains active |
