...
| `platform/computers/src/cli_grants/` and `queries/*cli*` | stock-CLI pairing ledger, named session-bound grants, shared browser/CLI quota, profile-bound fenced connection leases and owner revocation; installed acceptance remains delivery work |
