...
| Veoveo recording ingest | Version `2026-08-01`; authenticated protobuf batches and distinct Blueprint publications preserve native Rerun 0.35.0 stores, ordering, idempotency, and decoder-safe rollover markers. |
