...
IMAGES = {
    ...
    "system-map": (
        ...
        " HOSTED SERVERS. Inside it, draw one unified abstract capability-plane glyph made from"
        " several thin unlabelled horizontal layers; do not draw separate countable server boxes."
        " Join GATEWAY to HOSTED SERVERS with one dark right-pointing arrow labeled MCP + ADMIN."
    ...
    "harness-poster": (
        ...
        " thin arrow passes through a small chamber labeled STREAM and continues into the"
    ...
    "capability-map": (
        ...
        " left to right, top to bottom: row one MEDIA, STREAM, TIMESERIES; row two DUCKDB,"
