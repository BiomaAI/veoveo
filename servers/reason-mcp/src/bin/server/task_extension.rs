...
use super::tasks::{ReasonTaskInput, start_reason_task};

#[derive(Clone)]
pub(super) struct ReasonTaskExtension {
    state: Arc<AppState>,
}

impl ReasonTaskExtension {
...
impl TaskExtensionHandler for ReasonTaskExtension {
