...
mod well_known_tests {
    ...
    fn contract_declaration_resolves_from_the_embedded_manual() {
        let declaration =
            ContractDeclaration::from_docs(&SERVER_DOCS, UavSimMcp::capability_inventory());
