...
use veoveo_coordinates_mcp::contract::BatchTransformRequest;

#[derive(Clone)]
pub(super) struct CoordinatesTaskExtension {
    state: Arc<AppState>,
}

impl CoordinatesTaskExtension {
...
impl TaskExtensionHandler for CoordinatesTaskExtension {
