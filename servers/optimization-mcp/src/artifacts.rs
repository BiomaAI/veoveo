//! Artifact access for optimization-mcp, backed by the shared artifact plane.
//!
//! optimization no longer owns a private bucket or artifact metadata tables. It calls
