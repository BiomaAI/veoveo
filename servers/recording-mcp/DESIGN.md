...
| [Rerun 0.35.0](https://rerun.io/docs/) RRD | Immutable frozen and sealed segments retain one application id and recording id so the viewer presents a single logical store. |
