...
#[derive(Parser)]
#[command(name = "server", about = "Stream MCP server (streamable HTTP)")]
pub(super) struct Args {
    ...
    #[arg(long, default_value = "/etc/veoveo/stream/catalog.json")]
    pub(super) pipeline_catalog: PathBuf,
    #[arg(long, default_value = "/usr/local/bin/stream-gst-runner")]
    pub(super) gst_runner: PathBuf,
    #[arg(long, default_value_t = 3_600)]
    runner_timeout_s: u64,
    #[arg(long, default_value_t = 20)]
    live_startup_timeout_s: u64,
    ...
    pub(super) max_live_result_frames: usize,
    #[arg(long, default_value_t = 128)]
    pub(super) max_live_preview_chunks: usize,
    #[arg(long, default_value_t = 10_000)]
    pub(super) max_detections_per_frame: usize,
    #[arg(long, default_value_t = 268_435_456)]
    pub(super) max_runner_response_bytes: u64,
    #[arg(long, default_value_t = 4_194_304)]
    pub(super) max_live_event_bytes: u64,
    #[arg(long, default_value_t = 1_048_576)]
    pub(super) max_live_video_chunk_bytes: u64,
...
impl Args {
    ...
    pub(super) fn live_startup_timeout(&self) -> Duration {
        Duration::from_secs(self.live_startup_timeout_s)
    }
}
...
fn parse_allowed_host(value: &str) -> Result<String, String> {
    ...
    parse_allowed_host_authority(value)
        ...
        .ok_or_else(|| "expected a host authority such as stream-mcp:8797".to_owned())
}
...
fn parse_database_auth_level(value: &str) -> Result<StoreAuthLevel, String> {
    match value.parse::<StoreAuthLevel>() {
        ...
        Ok(_) => Err("stream requires database-scoped SurrealDB credentials".to_owned()),
