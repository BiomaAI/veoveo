...
| [Veoveo final task extension](../../mcp/task-extension) | Version `2026-06-30`; recording replay is durable, cancellable, resumable from governed identity, and result-addressable. A live session is direct bounded work, not an indefinitely running task. |
