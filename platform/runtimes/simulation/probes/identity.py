...
def inspect_identity() -> dict[str, object]:
    ...
    if torch.__version__ != "2.10.0+cu128":
        raise RuntimeError(f"expected Torch 2.10.0+cu128, loaded {torch.__version__}")
    ...
    if mixed_modules:
        raise RuntimeError(
            "mixed Warp/Newton module roots detected: "
    ...
    return {
        ...
        "isaac_lab": isaac_lab,
        "inspected_warp_newton_modules": inspected_modules,
