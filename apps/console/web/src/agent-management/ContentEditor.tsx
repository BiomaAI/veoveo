...
export function ContentEditor({ authoring, capabilities, templates, value, change, disabled }: {
  ...
  return <fieldset disabled={disabled} className="am-content">
    ...
    <div><h3>Capabilities</h3><p>{execution.kind === "managed" ? "Tools run with this instance's own service account." : "Tools use the current caller's permissions."} Choosing Computers does not grant access to a Computer.</p>
